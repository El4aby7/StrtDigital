    ...
    <section id="services" className="py-20 md:py-28">
      <div className="container-page">
        <Reveal className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-4 text-lg text-slate-600">{services.subtitle}</p>
        </Reveal>
          ...
          {services.items.map((s, i) => {
            ...
            return (
              <Reveal key={`${s.title}-${i}`} delay={i * 70}>
                <article className="group h-full rounded-2xl border border-line bg-white p-7 shadow-card transition-all duration-200 hover:-translate-y-1 hover:shadow-card-hover">
